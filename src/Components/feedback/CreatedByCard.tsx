      ...
      <div className="bg-gray-100 w-11/12 h-48 dark:bg-gray-700 relative shadow-xl overflow-hidden hover:shadow-2xl group rounded-xl p-5 transition-all duration-500 transform">
        <div className="flex items-center gap-4">
          ...
          <div className="w-fit transition-all transform duration-500">
            ...
            <p className="text-gray-500">{nameWithId}</p>
            <p className="text-gray-400">{classStudent}</p>
          </div>
        </div>
        <div className="absolute group-hover:bottom-1 delay-300 -bottom-16 transition-all duration-500 cursor-pointer bg-gray-600 dark:bg-gray-100 right-1 rounded-lg">
